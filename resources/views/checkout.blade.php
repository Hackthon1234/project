            ...
            <div class="grid gap-5">
                <div class="flex shadow border p-4 rounded-lg items-center justify-between">
                    <a href="{{ route('viewproduct', $cart->product_id) }}" class="flex">
                        <img src="{{ asset('images/products/' . $cart->product->photopath) }}" alt="Product Image"
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <form action="https://rc-epay.esewa.com.np/api/epay/main/v2/form" method="POST">
                            ...
                            <input type="hidden" id="success_url" name="success_url"
                                value="{{route('order.esewa',$cart->id)}}" required>
                            ...
                            <input value="Pay with eSewa" type="submit"
                                class="bg-red-500 text-white px-4 py-2 w-full rounded hover:bg-red-600 text center">
                        </form>
                    </div>
                </div>
            </div>
