    ...
    <div class="max-w-2xl mx-auto p-6">
        <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="mb-8 text-center">
                ...
                <p class="text-sm text-gray-500 mt-2">Enter the details of your new product below</p>
            </div>
            ...
            <div class="mb-6">
                ...
                <textarea name="description" id="description" rows="3"
                    ...
                    class="w-full px-4 py-3 text-base border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-200 focus:border-blue-500 transition duration-200">{{ old('description') }}</textarea>
                @error('description')
                    <p class="mt-2 text-sm text-red-600 flex items-center">
                        <i class="ri-error-warning-line mr-1"></i> {{ $message }}
                    </p>
