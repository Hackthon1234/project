{{--
    =====================================================
    VybeCart - Products Management
    =====================================================
    Description: List all products with details, stock levels, and management actions
                        ...
                        <tr class="hover:bg-blue-50/50 transition-colors duration-150">
                            ...
                            <td class="px-9  py-4 whitespace-nowrap">
                                <div class="text-sm text-indigo-600 font-medium">
                                    @if($product->discounted_price && is_numeric($product->discounted_price))
